...
class GPSTest( MarionTest ) :
    ...
    def test_get_locations_and_unknowns( self ) :
        locs, unks = get_locations_and_unknowns( ["University of Oxford", "blorfing"], False )
    ...
    def test_paper_lat_lon_query(self):
        ...
        with wos_reader.open_wos_h5( "test_data/irwin.h5" ) as w5 :
            locresults = wos_reader_query.paperLatLonQuery( w5, get_locations_and_unknowns_nocache )
        tmp = self.maxDiff
        self.maxDiff = None
    ...
    def test_paper_hexbin_query(self):
        ...
        """
        with wos_reader.open_wos_h5( "test_data/irwin.h5" ) as w5 :
            locresults = wos_reader_query.paperHexbinQuery( w5, get_locations_and_unknowns_nocache )
