...
from wtforms import StringField, BooleanField, SelectField, SubmitField, FieldList
...
class AddTabdataDatasetForm( Form ) :
    file_1 = FileField( "file_1", validators = [FileRequired()] )
    descriptionField = StringField('Description', validators=[Length(min=0, max=1024), DataRequired()] )
...
class AddTabdataQueryForm(Form):
    ...
    # "parameterFields" will be dynamically modified
